  ...
  Selectpicker.prototype = {
    ...
    createLi: function() {
      ...
      this.$element.find('option').each(function(index) {
        ...
        if ($this.data('thumbnail2')) {
          // Prepare thumbnail2
          text =
            '<span class="media">' +
              '<span class="media-left"><img src="' + $this.data('thumbnail2') + '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
